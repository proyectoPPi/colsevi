...
<div class="modal fade modal-dialog-center " id="ModalFormulario" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content-wrap">
			<form method="post" action="${pageContext.request.contextPath}/general/Configuracion/Guardar.html?" id="Formulario" data-modal="ModalFormulario" data-tabla="Tabla">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label>*Valor</label>
							<input type="text" class="form-control" id="valor" name="valor" data-bv-notempty="true" required="required"/>
						</div>
						<div class="form-group">
